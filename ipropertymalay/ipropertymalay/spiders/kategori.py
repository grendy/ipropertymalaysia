    ...
    def parse(self, response):
        ...
        try:
            ...
            for e in range(0,11):
                ...
                driver.find_element_by_xpath().send_keys(Keys.ADD,ti)
                coy = ""
                while coy != 'done':
                    import pdb;pdb.set_trace
                    ...
                    for i in range(1,27):
                        if i != 5 or i != 10 or i != 16 or i !=21:
                            try:
                                ...
                                direktori = '/home/grendy/Downloads/Telegram Desktop/Crawling/ipropertymalay/ipropertymalayagricultur/' + photo
